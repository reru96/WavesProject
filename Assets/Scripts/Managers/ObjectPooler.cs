...
public class ObjectPooler : Singleton<ObjectPooler>
{
    ...
    private Dictionary<Object, Queue<GameObject>> poolDictionary =
    ...
    private void InitializePools()
    {
        foreach (var entry in poolEntries)
        {
            ...
            {
                if (obj is Object data && data.prefab != null)
                {
    ...
    public void AddToPool(Object data, int size)
    {
    ...
    public GameObject Spawn(Object data, Vector3 position, Quaternion rotation)
    {
        if (data == null)
        {
    ...
    public T Spawn<T>(Object data, Vector3 position, Quaternion rotation) where T : Component
    {
